...
import br.com.softblue.bluefood.domain.pedido.PagamentoRepository;
...
import br.com.softblue.bluefood.infrastructure.web.security.SecurityUtils;
...
public class PedidoService {
	...
	public Pedido criarEPagar(Carrinho carrinho, String numCartao) throws PagamentoException {
		...
		if(statusPagamento != StatusPagamento.Aurotizado) {
